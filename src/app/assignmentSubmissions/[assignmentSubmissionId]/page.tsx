...
const AssignmentSubmission = () => {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <p>
        <strong>ID Asignación:</strong> {submission.assignment_id}
      </p>
      <p>
        <strong>ID Usuario Estudiante:</strong> {submission.student_user_id}
      </p>
      {submission.file_url && (
        <p>
      ...
      {submission.comment && (
        <p>
          <strong>Comentario:</strong> {submission.comment}
        </p>
      )}
      {submission.grade !== undefined && (
        <p>
          <strong>Calificación:</strong> {submission.grade}
        </p>
      )}
      {submission.feedback && (
        <p>
